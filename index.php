...
<html>
	...
	<head>
    	...
    	<link rel="icon" href="https://s13.postimg.org/uuo22h9uv/favicon.png" type="image/gif" sizes="16x16">
        <meta name="viewport" content="width=device-width, initial-scale=1">
    	<meta name="description" content="Portfolio Site">
    	<meta name="abstract" content="Portfolio site">
		<meta name="keywords" content="Petar Petkovic, Nis, Web Developer">
	...
	<body>
		...
		<div id="container">
			...
			<div class="navBar">
				<div class="leftNav">
					<span class="logo">
						<img src="https://s32.postimg.org/yfk6e47zp/logo.jpg" alt="logo" width="45px" height="45px">
					</span>
			...
			<div id="contact">
			    ...
			    <form action="" method="POST" enctype="multipart/form-data">	    
				    ...
				    <input name="email" size="40" type="text" placeholder="Your e-mail:" class="par"> <br/>
